...
public class ClientSocketNumsCiclico {
	...
	public ClientSocketNumsCiclico (String serverIP, int serverPort) {
		super();
...
//	}
	public static void main(String[] args) {
		...
		ClientSocketNumsCiclico cliente = new ClientSocketNumsCiclico("localhost", 8080);
		
		try {
			cliente.start();
			for (int i=0; i<10; i++) {
				Integer datoEnviado = i+1;
